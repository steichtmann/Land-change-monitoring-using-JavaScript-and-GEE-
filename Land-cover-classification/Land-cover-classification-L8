...
/*READ ME//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  USGS Landsat 8 Level 2, Collection 2, Tier 1 dataset (LANDSAT/LC08/C02/T1_L2) and a subsqeuent accuracy assessment.
...
var cloud_cover = 80;
      ...
      var bands = ['SR_B2','SR_B3','SR_B4', 'SR_B5','SR_B6','SR_B7','NDVI','NDBI','NDMI','MNDWI'];
                   
      var composite = image.select(bands);
      
      //Display
        Map.addLayer(image,{bands: ['SR_B4', 'SR_B3', 'SR_B2'], min: 0, max: 0.2}, 'True Color Image');
        print(image);
...
var Classes_for_SpectralProfiles  = *INPUT HERE*; // e.g. class0.merge(class1)...
      ...
      //Spectral profiles
          var subset = image.select('SR_B2', 'SR_B3', 'SR_B4', 'SR_B5', 'SR_B6', 'SR_B7');
          ...
          var wavelengths = [452,533,636,851,1566,2107];
...
//>>  INPUT
var Test_Samples  = vMine.merge(vVeg_natural).merge(vVeg_cultivated).merge(vUnvegetated).merge(vWater);
